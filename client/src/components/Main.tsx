...
export default function Main({ searchValue }: Props) {
  ...
  return (
    <>
      {/* <h2 style={{color: "black", fontWeight: 500, fontSize: "25px"}} className="movie-details-details">Movies</h2> */}
      <h2 style={{ color: "black", fontWeight: 500, fontSize: "25px" }} className="movie-details-details">
        {tabName === "favourite" ? "Favourites" : "Movies"}
      </h2>
